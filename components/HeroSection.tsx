    ...
    <>
      ...
      <section ref={heroRef} className="relative h-screen w-full overflow-hidden">
        ...
        >
          ...
          />
          {/* Degradado diagonal con colores vibrantes */}
        ...
        >
          ...
          >
            <motion.h1
              className={`font-script text-white text-6xl sm:text-6xl md:text-7xl lg:text-8xl xl:text-9xl leading-tight drop-shadow-2xl cursor-pointer px-4 flex items-center justify-center gap-3 sm:gap-4 md:gap-6 ${isMobile ? 'flex-col' : 'flex-row flex-wrap'}`}
              whileHover={isMobile ? {} : {
                scale: 1.05,
