...
// OPCIÓN 9: Hexágonos Elegantes
export default function CountdownOption9() {
  ...
  return (
    <section className="bg-gradient-to-b from-[#F4F1EB] to-white py-16 md:py-24 px-4">
      <motion.div
      ...
      >
        ...
        <h3 className="text-[#6B7C5E] text-sm md:text-base tracking-[0.3em] uppercase font-light mb-4">
          Nuestro Gran Día
        </h3>
        <p className="font-script text-[#C7B299] text-3xl md:text-4xl mb-12">
          en
        </p>
        ...
        <div className="flex justify-center gap-3 md:gap-6 mb-12">
          {[
            ...
            >
              <div 
                className="w-20 h-20 md:w-28 md:h-28 flex items-center justify-center mb-3 bg-white border-2 border-[#C7B299] shadow-md"
        ...
        <div className="h-px w-32 mx-auto bg-[#C7B299]/30 mb-6" />
